import { c as createLucideIcon, j as jsxRuntimeExports, S as Slot, a as cn, b as cva, r as reactExports, d as composeRefs, R as React2, u as useComposedRefs, e as React, B as Button } from "./index-p50AG2LA.js";
/**
...
function useAiChat() {
  ...
  const sendMessage = reactExports.useCallback(async (content) => {
        ...
        Card,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-0", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 p-4 flex flex-col gap-2 min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-sm text-foreground leading-tight line-clamp-2 group-hover:text-accent transition-colors duration-200", children: link.title }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mt-auto gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1 flex-wrap", children: (_a = link.tags) == null ? void 0 : _a.slice(0, 2).map((tag) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Badge,
                  {
                    variant: "secondary",
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
                    onClick: () => {
                      var _a;
                      (_a = document.getElementById("content")) == null ? void 0 : _a.scrollIntoView({ behavior: "smooth" });
                    },
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Tabs,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(TabsList, { className: "mb-6 bg-muted/60 border border-border w-full sm:w-auto grid grid-cols-4 sm:flex", children: TAB_CONFIG.map((tab) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                TabsTrigger,
                {
                  value: tab.value,
              ...
              TAB_CONFIG.map((tab) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                TabsContent,
                {
                  ...
                  ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4", children: filteredLinks.map((link, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(LinkCard, { link, index: i }, link.id)) })
                },
                tab.value
              ))
            ]
