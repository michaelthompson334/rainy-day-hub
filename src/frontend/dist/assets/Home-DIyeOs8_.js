...
const ChatRequest = Record({ "message": Text });
const ChatResponse = Record({ "reply": Text });
const ChatHistoryEntry = Record({
  "id": Text,
  "content": Text,
  "role": Text,
  "timestamp": Int
...
Service({
  "addFavorite": Func([Text], [], []),
  "chat": Func([ChatRequest], [ChatResponse], []),
  "clearChatHistory": Func([], [], []),
  "getChatHistory": Func([], [Vec(ChatHistoryEntry)], []),
  "getFavorites": Func([], [Vec(Text)], []),
  "removeFavorite": Func([Text], [], []),
  "saveChatMessage": Func([ChatHistoryEntry], [], []),
  "transform": Func(
    [TransformationInput],
...
const idlFactory = ({ IDL: IDL2 }) => {
  const ChatRequest2 = IDL2.Record({ "message": IDL2.Text });
  const ChatResponse2 = IDL2.Record({ "reply": IDL2.Text });
  const ChatHistoryEntry2 = IDL2.Record({
    "id": IDL2.Text,
    "content": IDL2.Text,
    "role": IDL2.Text,
    "timestamp": IDL2.Int
  ...
  return IDL2.Service({
    ...
    "chat": IDL2.Func([ChatRequest2], [ChatResponse2], []),
    "clearChatHistory": IDL2.Func([], [], []),
    "getChatHistory": IDL2.Func([], [IDL2.Vec(ChatHistoryEntry2)], []),
    "getFavorites": IDL2.Func([], [IDL2.Vec(IDL2.Text)], []),
    "removeFavorite": IDL2.Func([IDL2.Text], [], []),
    "saveChatMessage": IDL2.Func([ChatHistoryEntry2], [], []),
    "transform": IDL2.Func(
...
const WELCOME_MESSAGE = {
  id: "welcome",
  role: "assistant",
  content: "Hello! I'm Rain-Bot, your cozy companion for rainy days. 🌧️ Ask me anything — about rain, what to do on a rainy day, or just chat!",
  timestamp: Date.now()
};
...
function useAiChat() {
  ...
  reactExports.useEffect(() => {
    ...
    actor.getChatHistory().then((entries) => {
  ...
  const sendMessage = reactExports.useCallback(
    async (content) => {
      ...
      await new Promise(
        (resolve) => setTimeout(resolve, 800 + Math.random() * 700)
      );
      const response = RAIN_BOT_RESPONSES[responseIndex % RAIN_BOT_RESPONSES.length];
      responseIndex++;
...
function useFavorites() {
  ...
  const addMutation = useMutation({
    ...
    onMutate: async (linkId) => {
      ...
      queryClient.setQueryData(["favorites"], [...prev, linkId]);
      return { prev };
    },
    onError: (_err, _linkId, ctx) => {
      if ((ctx == null ? void 0 : ctx.prev) !== void 0) {
  ...
  const isFavorited = (linkId) => favorites.includes(linkId);
...
const LINKS = [
  {
    ...
    description: "Explore the beauty and solace of rainy days through carefully selected fiction, poetry, and memoir.",
  ...
  },
  {
    ...
    description: "Why rain smells so good — the fascinating chemistry behind that earthy, calming scent after rainfall.",
  ...
  },
  {
    ...
    description: "The ultimate watchlist for curling up with a blanket when the rain won't stop.",
  ...
  },
  {
    ...
    description: "A stunning collection of fine art photography capturing the quiet drama of rain and overcast skies.",
  ...
  },
  {
    ...
    description: "Blurred cityscapes and bokeh streetlights seen through rain-streaked windows by photographers worldwide.",
  ...
  },
  {
    ...
    description: "Binaural rain, distant thunder, and café ambient noise — perfect for focus or falling asleep.",
  ...
  },
  {
    ...
    description: "Smooth jazz piano and soft bass — the definitive soundtrack for a rainy afternoon indoors.",
  ...
  },
  {
    ...
    description: "An award-winning survival game set in a beautifully bleak, rain-soaked ecosystem. Hauntingly atmospheric.",
  ...
  },
  {
    ...
    description: "Warm your soul with 20 hearty recipes crafted for cold, grey afternoons — from classic ramen to Tuscan soup.",
...
const TAB_CONFIG = [
  ...
  },
  {
    value: "photography",
    label: "Photography",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Camera, { className: "w-3.5 h-3.5" })
  },
  { value: "sounds", label: "Sounds", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Music, { className: "w-3.5 h-3.5" }) },
  {
    value: "resources",
    label: "Resources",
    ...
    motion.div,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        Card,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-24 h-24 shrink-0 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 p-4 flex flex-col gap-2 min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2 min-w-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-sm text-foreground leading-tight line-clamp-2 group-hover:text-accent transition-colors duration-200 flex-1 min-w-0", children: link.title }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
                    onClick: onStarClick,
                    "aria-label": isAuthenticated ? isFavorited ? "Remove from favorites" : "Add to favorites" : "Log in to save favorites",
                    "data-ocid": `links.favorite_button.${index + 1}`,
                    className: `shrink-0 transition-colors duration-200 mt-0.5 ${isFavorited ? "text-accent" : "text-muted-foreground/40 hover:text-accent/60"}`,
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Star,
                      {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground line-clamp-2 font-body leading-relaxed", children: link.description }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mt-auto gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1 flex-wrap", children: (_a2 = link.tags) == null ? void 0 : _a2.slice(0, 2).map((tag) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Badge,
                  {
                    variant: "secondary",
...
function ChatPanel() {
  const { messages, sendMessage, isLoading, clearHistory, isAuthenticated } = useAiChat();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto p-4 space-y-3 min-h-0", children: [
      messages.map((msg) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            msg.role === "assistant" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-7 h-7 rounded-full bg-accent/20 border border-accent/30 flex items-center justify-center shrink-0 mt-0.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Bot, { className: "w-3.5 h-3.5 text-accent" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                className: `max-w-[80%] px-3 py-2 rounded-xl text-sm font-body leading-relaxed ${msg.role === "user" ? "bg-primary text-primary-foreground rounded-br-sm" : "bg-muted text-foreground rounded-bl-sm border border-border"}`,
      ...
      isLoading && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-7 h-7 rounded-full bg-accent/20 border border-accent/30 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Bot, { className: "w-3.5 h-3.5 text-accent" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-muted border border-border rounded-xl rounded-bl-sm px-4 py-3 flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "w-3.5 h-3.5 text-accent animate-spin" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Rain-Bot is thinking…" })
            ] })
          ]
        }
      ),
    ...
    isAuthenticated && hasHistory && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-3 pb-1 flex justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        type: "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 border-t border-border bg-card/50 flex gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Input,
        {
          value: input,
...
function Home() {
  ...
  const filteredLinks = activeTab === "favorites" ? LINKS.filter((l) => favorites.includes(l.id)) : LINKS.filter((l) => l.category === activeTab);
  const showFavoritesTab = isAuthenticated || favorites.length > 0;
  const handleStarClick = (linkId) => {
    if (!isAuthenticated) {
      login();
      return;
    }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "section",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-background/95 via-background/70 to-background/30" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Badge,
                  {
                    ...
                    children: "🌧️ Your rainy day companion"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display font-bold text-4xl sm:text-5xl text-foreground leading-tight mb-4", children: [
                  "The Quiet Rhythm of",
                  " ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient-accent", children: "Falling Rain." })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-lg text-muted-foreground leading-relaxed mb-6", children: "Explore curated content, ambient sounds, photography, and resources — everything you need to make the most of a cozy rainy day." }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
                    onClick: () => {
                      var _a2;
                      (_a2 = document.getElementById("content")) == null ? void 0 : _a2.scrollIntoView({ behavior: "smooth" });
                    },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "content", className: "bg-background py-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col lg:flex-row gap-8 items-start", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "articles" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Tabs,
          {
            value: activeTab,
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                TabsList,
                {
                  ...
                  children: [
                    TAB_CONFIG.map((tab) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      TabsTrigger,
                      {
                        value: tab.value,
                    ...
                    showFavoritesTab && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      TabsTrigger,
                      {
                        value: "favorites",
                        className: "flex items-center gap-1.5 text-xs sm:text-sm data-[state=active]:text-accent data-[state=active]:border-b-2 data-[state=active]:border-accent",
                        ...
                        children: [
                          ...
                          favorites.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline text-xs bg-accent/20 text-accent rounded-full px-1.5 min-w-[1.25rem] text-center leading-5", children: favorites.length })
                        ]
                      }
                    )
                  ]
              ...
              TAB_CONFIG.map((tab) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                TabsContent,
                {
                  value: tab.value,
                  className: "mt-0",
                  children: filteredLinks.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      className: "text-center py-16 text-muted-foreground",
                      "data-ocid": "links.empty_state",
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body", children: "No content here yet — check back soon!" })
                    }
                  ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4", children: filteredLinks.map((link, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    LinkCard,
                    {
                      link,
                      index: i,
              ...
              showFavoritesTab && /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "favorites", className: "mt-0", children: filteredLinks.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: isAuthenticated ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-muted-foreground mb-1", children: "No favorites yet" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground/60", children: "Click the ☆ star on any link to save it here." })
                  ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "w-10 h-10 text-muted-foreground/30 mx-auto mb-3" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-muted-foreground mb-3", children: "Log in to save and see your favorites" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      Button,
                      {
                        variant: "outline",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "aside",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-border bg-card shadow-elevated overflow-hidden", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-3 border-b border-border bg-card flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-2 h-2 rounded-full bg-accent animate-pulse" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-semibold text-sm text-foreground", children: "Ask Rain-Bot" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Badge,
                {
                  variant: "secondary",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-80 flex flex-col", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChatPanel, {}) })
          ] })
        }
      )
    ] }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "photography" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "sounds" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "resources" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-muted/30 border-t border-border py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        initial: { opacity: 0, y: 20 },
        whileInView: { opacity: 1, y: 0 },
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-2xl sm:text-3xl text-foreground mb-4", children: "Made for Rainy Days" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-muted-foreground leading-relaxed text-base max-w-2xl mx-auto", children: "Rainy Day Hub is your one-stop destination for everything cozy. Browse curated articles, discover stunning photography, find ambient sounds, and chat with Rain-Bot — our AI companion that knows everything about making the most of grey skies." })
        ]
      }
    ) }) })
  ] });
